  ...
  return (
    <footer className="relative px-6 md:px-10 pt-16 pb-8 border-t border-hairline">
      <div className="grid md:grid-cols-12 gap-10 mb-12 md:mb-16">
        ...
        <div className="grid grid-cols-2 md:grid-cols-subgrid md:col-span-7 gap-6 md:gap-10">
          ...
          <div className="md:col-span-2 font-mono text-[11px] tracking-[0.18em] uppercase text-ink-soft flex flex-col gap-2">
            ...
            <a href="mailto:practice@halton.works" className="hover:text-ink transition-colors break-all">practice@halton.works</a>
      ...
      <div className="font-display text-[clamp(4rem,22vw,18rem)] leading-[0.85] tracking-[-0.05em] -mb-2 md:-mb-4 select-none">
        HALTON
      </div>

      <div className="flex flex-col md:flex-row justify-between gap-3 pt-6 border-t border-hairline font-mono text-[10px] md:text-[11px] tracking-[0.18em] uppercase text-ink-soft">
